...
export const ASTRO_TOOLS: AstroTool[] = [
  ...
  {
    id: "biodata",
    titleTa: "ஜாதக வரன் குறிப்பு (Astro Biodata)",
    titleEn: "Matrimonial Astro Biodata Maker",
    descriptionTa: "ராசி மற்றும் நவாம்ச கட்டங்களுடன் கூடிய நேர்த்தியான திருமண வரன் ஜாதக பயோடேட்டாவை உருவாக்கி PDF ஆக பதிவிறக்குங்கள்.",
    descriptionEn: "Create elegant Tamil matrimonial biodatas complete with horoscope charts and export to high-res PDF.",
    category: "marriage",
    path: "/biodata",
    icon: "UserCheck",
    status: "available",
    popular: true,
    keywords: ["biodata", "matrimony", "marriage", "pdf", "பயோடேட்டா", "வரன்", "ஜாதகக் குறிப்பு"],
  },
  ...
  // Category: Information & Transparency
  {
    ...
    descriptionTa: "நாசா JPL DE440, VSOP87 வானியல் மாதிரிகள், திருக்கணித அயனாம்சம் (இயல்புநிலை) & சித்திரபக்ஷ லஹிரி மற்றும் முழு பாவ கணித ஆவணங்கள்.",
    descriptionEn: "Complete technical disclosure: Astronomy Engine VSOP87/ELP2000, Thirukanitham (Default) & Chitrapaksha Lahiri, and Whole Sign rules.",
    category: "info",
