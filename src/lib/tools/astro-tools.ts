...
export const ASTRO_TOOLS: AstroTool[] = [
  ...
  {
    id: "panchangam-tool",
    titleTa: "திருக்கணித பஞ்சாங்கம்",
    titleEn: "Thirukanitham Panchangam",
    descriptionTa: "ராகு காலம், எமகண்டம், குளிகை, அபிஜித் முகூர்த்தம் மற்றும் கௌரி நல்ல நேரம் அடங்கிய உடனடி பஞ்சாங்கப் பார்வை.",
    descriptionEn: "Instant Panchangam tool with Rahu Kalam, Yamagandam, Gulikai, Abhijit, and Gowri timings.",
    category: "panchangam",
    path: "/panchangam",
    icon: "Clock",
    status: "available",
    popular: true,
    keywords: ["panchangam", "rahu kalam", "yamagandam", "gulikai", "முகூர்த்தம்", "ராகு காலம்"],
  },
  {
    id: "nazhigai",
