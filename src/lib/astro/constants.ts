...
export const SCHOOLS: { id: School; en: string; ta: string; hintEn: string; hintTa: string }[] = [
  {
    ...
    en: "Thirukanitham",
    ta: "திருக்கணிதம்",
    hintEn: "Modern Drik Ganitha — accurate planetary ephemeris",
    hintTa: "நவீன வானியல் முறை · துல்லிய திரிக கணிதம்",
  },
  {
    id: "vakya",
    en: "Vakya Karana",
    ta: "வாக்கியம்",
    hintEn: "Traditional Surya Siddhanta / Kali epoch — temple panchangam",
    hintTa: "பாரம்பரிய வாக்கிய முறை · திருக்கோயில் பஞ்சாங்கம்",
  },
  {
    id: "lahiri",
    en: "Lahiri",
    ta: "லாஹிரி",
    hintEn: "Chitrapaksha Ayanamsa — Indian National Ephemeris standard",
    hintTa: "சித்திரபக்ஷ அயனாம்சம் · தேசிய பஞ்சாங்க முறை",
  },
];
