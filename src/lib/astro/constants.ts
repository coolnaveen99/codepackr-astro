...
export const SCHOOLS: { id: School; en: string; ta: string; hintEn: string; hintTa: string }[] = [
  {
    ...
    en: "Thirukanitham",
    ta: "திருக்கணிதம்",
    hintEn: "Drik ephemeris + Tamil linear ayanamsa (22°27.6′ @ 1900, 50.016″/yr)",
    hintTa: "திரிக் கணிதம் + தமிழ் நேர்கோட்டு அயனாம்சம் (1900-ல் 22°27.6′)",
  },
  {
    id: "vakya",
    en: "Vakya Karana",
    ta: "வாக்கியம்",
    hintEn: "Mean motions + manda equation, Thirukanitham ayan — temple-style comparison",
    hintTa: "சராசரி கதி + மந்த சமன்பாடு, திருக்கணித அயனாம்சம் — கோயில் ஒப்பீடு",
  },
  {
    id: "lahiri",
    en: "Lahiri",
    ta: "லாஹிரி",
    hintEn: "Drik ephemeris + Lahiri/Chitrapaksha ayanamsa (Indian National Ephemeris)",
    hintTa: "திரிக் கணிதம் + லாஹிரி/சித்திரபக்ஷ அயனாம்சம் (தேசிய தரம்)",
  },
];
